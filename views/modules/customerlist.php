...
<body class="bg-gray-600 flex flex-col min-h-screen">
    ...
    <div class="flex justify-center"> 
        <h1 class="mb-4 text-3xl font-extrabold text-gray-900 md:text-5xl lg:text-6xl flex">
            <span class="text-gray-900">Customer List</h1>
    </div>

    
<div class="relative overflow-x-auto shadow-md sm:rounded-lg mx-10 mb-10 p-10 bg-white">
    
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400" id="custable">
        ...
        <?php
            ...
            $customer = (new ControllerCustomer)->ctrShowCustomerList();
            foreach ($customer as $key => $value) {
              echo '<tr class="">
                      <td class="px-6 py-4 bg-gray-500 text-black font-medium">'.$value["cusname"].'</td>
                      <td class="px-6 py-4 bg-gray-500 text-black font-medium">'.$value["custype"].'</td>
                      <td class="px-6 py-4 bg-gray-500 text-black font-medium">'.$value["cusnum"].'</td>
                      <td class="px-6 py-4 bg-gray-500 text-black font-medium">'.$value["cusadd"].'</td>
                      <td class="px-6 py-4 bg-gray-500 text-black font-medium">'.$value["cusemail"].'</td>
                    </tr>';
              }
          ?>
        </tbody>
